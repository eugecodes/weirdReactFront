...
import { ClientModel } from "@/src/core/client/domain/models/client_model";
...
export class ClientDataModel implements DataModel<ClientModel> {
  @Expose()
  id!: Id;
  ...
  fromDomain(domainObject: ClientModel) {
