...
import { DetailCommissionModel } from "../../domain/models/detail_commission_model";
...
export class DetailCommissionDataModel {
  @Expose()
  id!: Id;
  ...
  toDomain() {
    ...
    return new DetailCommissionModel({
      id: this.id,
      marketerId,
      name: this.name,
      priceType,
      ...
      rateTypeSegmentation: this.rateTypeSegmentation,
