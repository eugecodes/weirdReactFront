...
import { RateRangeForm } from "./range_form";

const RateRangeFormFlex = styled(RateRangeForm)`
...
const RateRangeFormGrid = styled(RateRangeForm)`
...
export default { RateRangeFormFlex, RateRangeFormGrid };
